            ...
            <div className='container'>
                <div className='tab-style'>
                    <ul class="nav nav-pills mb-3 d-flex justify-content-center p-4" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link nav-link-style-emp" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Delete</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link nav-link-style-emp" id="pills-update-tab" data-bs-toggle="pill" data-bs-target="#pills-update" type="button" role="tab" aria-controls="pills-update" aria-selected="false">Update</button>
                        </li>
                    </ul>
                    <div class="tab-content tab-content-style" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0"><div class=' d-flex justify-content-center align-items-center'><Delete /></div></div>
                        <div class="tab-pane fade" id="pills-update" role="tabpanel" aria-labelledby="pills-update-tab" tabindex="0"><div class=' d-flex justify-content-center align-items-center'><Update /></div></div>
                    </div>
                </div>
            </div>
            <Footer />
